            ...
            <div class="section-title pt-5">
                <div class="row ">
                    <div class="col-lg-12 text-center">
                        ...
                        <h2 style="font-size: 35px;"><span>Investor
                        </span> Complain Data
                                ...
                                <div class="row align-items-center justify-content-center">
                                    ...
                                    <div class="row mt-3 justify-content-center">
                                        ...
                                        <div class="col-sm-4 col-lg-4 mt-3">
                                            <a href="./assets/form/BOG 11TH FEB 2025 FOR SITE INVESTER CHARTER (1).pdf" target="_blank">
                                            <div class="pdf" style="display: flex; align-items: center; gap: 10px;">
                                                <img src="./assets/img/icons/pdf.png" width="60" alt="">
                                                <h5 style="margin: 0;">BOG 11TH FEB 2025 FOR SITE INVESTER CHARTER</h5>
                                            </div>
                                            </a>
                                        </div>
