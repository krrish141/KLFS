                ...
                <div class="container">
                    <div class="title-content">
                        ...
                        <ul>
                            ...
                            <li>
                                <span>Investor Chater - for stock broker and for DP
                                </span>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="section-title pt-5">
                <div class="row ">
                    <div class="col-lg-12 text-center">
                        ...
                        <h2 style="font-size: 35px;"><span>Investor Chater </span>- for stock broker and for DP
                        </h2>
                    </div>
                                ...
                                <div class="row align-items-center justify-content-center">
                                    ...
                                    <div class="row mt-3 justify-content-center">
                                        ...
                                        <div class="col-sm-4 col-lg-4 mt-3">
                                            <a href="./assets/form/Investor Charter of DP.pdf" target="_blank">
                                                <div class="pdf" style="display: flex; align-items: center; gap: 10px;">
                                                    <img src="./assets/img/icons/pdf.png" width="60" alt="">
                                                    <h5 style="margin: 0;">Investor Charter of DP</h5>
                                                </div>
                                            </a>
                                        </div>

                                        <div class="col-sm-4 col-lg-4 mt-3">
                                            <a href="./assets/form/Investor Charter of Stock Exchanges.pdf"
                                                target="_blank">
                                                <div class="pdf" style="display: flex; align-items: center; gap: 10px;">
                                                    <img src="./assets/img/icons/pdf.png" width="60" alt="">
                                                    <h5 style="margin: 0;">Investor Charter of Stock Exchanges </h5>
                                                </div>
                                            </a>
                                        </div>
