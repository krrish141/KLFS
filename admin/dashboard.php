...
<head>
    ...
    <!-- App title -->
    <title>Kalpalabdhi Financials | Dashboard</title>
                                ...
                                <div class="card-box widget-box-one">
                                    ...
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow"
                                            title="Statistics">OPEN Account Request</p>
                                        <?php $query = mysqli_query($con, "select * from openaccount where Is_Active=1");
