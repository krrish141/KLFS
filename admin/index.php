...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Kalpalabdhi Financials| Admin Panel</title>
    ...
    <body class="bg-transparent" style="background-color:white">
                                ...
                                <div class="text-center account-logo-box">
                                    <h2 class="text-uppercase">
                                        <a href="index.html" class="text-success">
                                            <span><img src="assets/images/logo.jpg" alt="" style="    width: 100%;
    height: auto;"></span>
                                        </a>
                                    </h2>
